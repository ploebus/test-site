...
<table class='table table-striped'>
	...
	<tr>
		...
		<td><?php echo date_format(date_create($child->last_status_date),'m/d/Y'); ?></td>
		<td><?php echo $child->AssignedTo ;?></td>
		<td style='font-size:.9em'><a href ="view_child/<?php echo $child->child_id ;?>" class="recordView">VIEW</a> | <a class="reopen_child" data-kid="<?php echo $child->child_id; ?>" href="reopen_child/<?php echo $child->child_id; ?>">REOPEN RECORD</a></td>
	</tr>
	<?php endforeach;?>
</table>
